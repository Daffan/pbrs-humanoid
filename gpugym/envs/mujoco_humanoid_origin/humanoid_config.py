...
class MujocoInfantCfg(LeggedRobotCfg):
    ...
    class init_state(LeggedRobotCfg.init_state):
        ...
        dof_pos_range = {
            ...
            'hip_x_right': [-0.25, -0.15],
            'hip_z_right': [-0.15, -0.05],
            'hip_y_right': [-0.25, -0.15],
            'knee_right': [-0.25, -0.15],
            'ankle_y_right': [-0.1, 0.1],
            'ankle_x_right': [-0.1, 0.1],
            'hip_x_left': [-0.35, -0.25],
            'hip_z_left': [-0.15, -0.05],
            'hip_y_left': [-0.25, -0.15],
            'knee_left': [-0.25, -0.15],
            'ankle_y_left': [-0.1, 0.1],
            'ankle_x_left': [-0.1, 0.1],

            'shoulder1_right': [0.8, 0.8],
            'shoulder2_right': [-1.0, -1.0],
            'elbow_right': [-1.4, -1.4],
            'shoulder1_left': [0.8, 0.8],
            'shoulder2_left': [-1.0, -1.0],
            'elbow_left': [-1.4, -1.4]
        }
        ...
        dof_vel_range = {
            ...
            'shoulder1_right': [-0.1, 0.1],
            'shoulder2_right': [-0.1, 0.1],
            'elbow_right': [-0.1, 0.1],
            'shoulder1_left': [-0.1, 0.1],
            'shoulder2_left': [-0.1, 0.1],
            'elbow_left': [-0.1, 0.1]
        }
    ...
    class asset(LeggedRobotCfg.asset):
        file = '{LEGGED_GYM_ROOT_DIR}'\
            '/resources/robots/mujoco_humanoid/humanoid.xml'
        keypoints = ["base"]
        end_effectors = ['foot_right', 'foot_left']
        foot_name = 'foot'
...
class MujocoInfantCfgPPO(LeggedRobotCfgPPO):
    ...
    class runner(LeggedRobotCfgPPO.runner):
        ...
        max_iterations = 1000
        run_name = '0825'
        experiment_name = 'MujocoHumanoid_Locomotion'
        save_interval = 50
